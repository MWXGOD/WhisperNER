...
snapshot_download(repo_id="openai/whisper-medium", local_dir = "cache/whisper-medium", ignore_patterns=["tf_model.h5", "flax_model.msgpack", "model.safetensors", "model.fp32-00001-of-00002.safetensors", "model.fp32-00002-of-00002.safetensors"], resume_download=True)

# snapshot_download(repo_id="openai/whisper-large", local_dir = "cache/whisper-large", ignore_patterns=["tf_model.h5", "flax_model.msgpack", "model.safetensors", "model.fp32-00001-of-00002.safetensors", "model.fp32-00002-of-00002.safetensors"], resume_download=True)
